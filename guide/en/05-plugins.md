...
how a build is run, ready information about a build, or modify a build once
complete.
...
[rollup-plugin-json](https://github.com/rollup/rollup-plugin-json/blob/master/src/index.js)
which generates a 'fake AST' to speed up Rollup's handling of large JSON files.
